...
class AC101: public AudioDriver {
...
public:
	...
	// Convenience method
	int setup(int fs=48000, int channelCount=2, int bitClkPin=27, int lrClkPin=26, int dataOutPin=14, int dataInPin=25, int enablePin=GPIO_NUM_21, i2s_port_t i2sPort=I2S_NUM_0);
